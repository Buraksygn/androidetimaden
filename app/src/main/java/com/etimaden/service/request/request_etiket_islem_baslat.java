...
public class request_etiket_islem_baslat {
    ...
    public String _zetiket;

    public request_etiket_islem_baslat(){}


    public request_etiket_islem_baslat(	String v__zsunucu_ip_adresi,String v__zaktif_alt_tesis,String v__zaktif_tesis,String v__zsurum,String v__zkullaniciadi,String v__zsifre,String v_aktif_sunucu,String v_aktif_kullanici,String v__zetiket)
    {
