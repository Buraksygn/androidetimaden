...
public class SweetAlertDialogG extends Dialog implements View.OnClickListener {
    ...
    public SweetAlertDialogG hideConfirmButton() {
        this.mHideConfirmButton = true;
        return this;
    }

    public interface OnSweetClickListener {
        void onClick(SweetAlertDialogG sweetAlertDialog);
    }

    public SweetAlertDialogG(Context context) {
        ...
        mModalOutAnim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                mDialogView.post(new Runnable() {
                    ...
                    public void run() {
                        if (mCloseFromCancel) {
                            SweetAlertDialogG.super.cancel();
                        } else {
                            SweetAlertDialogG.super.dismiss();
                        }
                    }
                });
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNeutralButton.setFocusable(false);
...
//                    mButtonsContainer.setVisibility(View.GONE);
    ...
    public SweetAlertDialogG setTitleText(String text) {
        mTitleText = text;
    ...
    public SweetAlertDialogG setCustomImage(int resourceId) {
    ...
    public SweetAlertDialogG showCancelButton(boolean isShow) {
        mShowCancel = isShow;
    ...
    public SweetAlertDialogG showContentText(boolean isShow) {
        mShowContent = isShow;
        if (mContentTextView != null) {
    ...
    public SweetAlertDialogG setCancelText(String text) {
        mCancelText = text;
    ...
    public SweetAlertDialogG setConfirmText(String text) {
        mConfirmText = text;
    ...
    public SweetAlertDialogG setCancelClickListener(OnSweetClickListener listener) {
        mCancelClickListener = listener;
        return this;
    }

    public SweetAlertDialogG setConfirmClickListener(OnSweetClickListener listener) {
        mConfirmClickListener = listener;
        return this;
    }

    public SweetAlertDialogG setNeutralText(String text) {
        mNeutralText = text;
    ...
    public SweetAlertDialogG setNeutralClickListener(OnSweetClickListener listener) {
    ...
    public SweetAlertDialogG setConfirmButton(String text, OnSweetClickListener listener) {
        this.setConfirmText(text);
        this.setConfirmClickListener(listener);
        return this;
    }

    public SweetAlertDialogG setConfirmButton(int resId, OnSweetClickListener listener) {
    ...
    public SweetAlertDialogG setCancelButton(String text, OnSweetClickListener listener) {
        this.setCancelText(text);
        this.setCancelClickListener(listener);
        return this;
    }

    public SweetAlertDialogG setCancelButton(int resId, OnSweetClickListener listener) {
        String text = getContext().getResources().getString(resId);
        setCancelButton(text, listener);
        return this;
    }

    public SweetAlertDialogG setNeutralButton(String text, OnSweetClickListener listener) {
        this.setNeutralText(text);
        this.setNeutralClickListener(listener);
        return this;
    }

    public SweetAlertDialogG setNeutralButton(int resId, OnSweetClickListener listener) {
        String text = getContext().getResources().getString(resId);
     ...
     */
    public SweetAlertDialogG setContentTextSize(int value) {
     ...
     * @param view
     */
    public SweetAlertDialogG setCustomView(View view) {
        mCustomView = view;
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.cancel_button) {
            ...
            if (mConfirmClickListener != null) {
                mConfirmClickListener.onClick(SweetAlertDialogG.this);
            } else {
                dismissWithAnimation();
            }
        } else if (v.getId() == R.id.neutral_button) {
            if (mNeutralClickListener != null) {
                mNeutralClickListener.onClick(SweetAlertDialogG.this);
            } else {
                dismissWithAnimation();
            }
        }
