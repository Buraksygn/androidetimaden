...
public class View_sevkiyat_urun_sevkiyat {
    public String _zHataAciklama = "";
    public String _zAciklama = "";
    public String _zSonuc = "";

    public Urun_sevkiyat _result;

    public View_sevkiyat_urun_sevkiyat() {
    }

    public View_sevkiyat_urun_sevkiyat(String _zHataAciklama, String _zAciklama, String _zSonuc, Urun_sevkiyat _result) {
    ...
    public Urun_sevkiyat get_result() {
        return _result;
    }

    public void set_result(Urun_sevkiyat _result) {
        this._result = _result;
    }
}
