...
public class ViewAktifIsemirleriListesi {

    private String _zHataAciklama = "";
    private String _zAciklama = "";
    private String _zSonuc = "";

    private List<Gemi_Teslimat> _isemirleriListesi;

    public ViewAktifIsemirleriListesi(String _zHataAciklama, String _zAciklama, String _zSonuc, List<Gemi_Teslimat> _isemirleriListesi) {
        this._zHataAciklama = _zHataAciklama;
        this._zAciklama = _zAciklama;
        this._zSonuc = _zSonuc;
        this._isemirleriListesi = _isemirleriListesi;
    }
    ...
    public List<Gemi_Teslimat> getisemirleriListesi() {
