...
public class requesttoplamaTest {
    ...
    public String _girilendeger = "";

    public requesttoplamaTest() {
    }

    public requesttoplamaTest(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, String _girilendeger) {
        ...
        this._girilendeger = _girilendeger;
    }
    ...
    public String get_girilendeger() {
        return _girilendeger;
    }

    public void set_girilendeger(String _girilendeger) {
        this._girilendeger = _girilendeger;
    }
}
