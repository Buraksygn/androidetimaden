...
public class request_demirbas_sayim_string {
    ...
    private demirbas_sayim  demirbasSayim;
    private String  value;

    public request_demirbas_sayim_string() {
    }

    public request_demirbas_sayim_string(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, demirbas_sayim demirbasSayim, String value) {
        ...
        this.demirbasSayim = demirbasSayim;
        this.value = value;
    }
    ...
    public demirbas_sayim getDemirbasSayim() {
        return demirbasSayim;
    }

    public void setDemirbasSayim(demirbas_sayim demirbasSayim) {
        this.demirbasSayim = demirbasSayim;
    }
