...
public class request_uruntag_list_uruntag {
    ...
    private Urun_tag etiket;
    private List<Urun_tag> urun_listesi;

    public request_uruntag_list_uruntag() {
    }

    public request_uruntag_list_uruntag(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, Urun_tag etiket, List<Urun_tag> urun_listesi) {
    ...
    public Urun_tag getEtiket() {
        return etiket;
    }

    public void setEtiket(Urun_tag etiket) {
        this.etiket = etiket;
    }
