...
public class request_sevkiyat_isemri_sevkiyat_isemri {
    ...
    private Sevkiyat_isemri sevk_is;
    private Sevkiyat_isemri konteyner;

    public request_sevkiyat_isemri_sevkiyat_isemri() {
    }

    public request_sevkiyat_isemri_sevkiyat_isemri(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, Sevkiyat_isemri sevk_is, Sevkiyat_isemri konteyner) {
    ...
    public Sevkiyat_isemri getSevk_is() {
        return sevk_is;
    }

    public void setSevk_is(Sevkiyat_isemri sevk_is) {
        this.sevk_is = sevk_is;
    }

    public Sevkiyat_isemri getKonteyner() {
        return konteyner;
    }

    public void setKonteyner(Sevkiyat_isemri konteyner) {
        this.konteyner = konteyner;
    }
}
