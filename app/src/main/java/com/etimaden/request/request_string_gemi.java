...
public class request_string_gemi {
    ...
    private GemiGelismeDurum gelismeTuru;

    public request_string_gemi() {
    }

    public request_string_gemi(
            String _zsunucu_ip_adresi,
            String _zaktif_alt_tesis,
            String _zaktif_tesis,
            String _zsurum,
        ...
        this.gemi = _gemiBilgi;
        this.gelismeTuru = _gelismeTuru;
    }
    ...
    public Gemi get_gemi() {
        return gemi;
    }

    public void set_gemi(Gemi _gemiBilgi) {
        this.gemi = _gemiBilgi;
    }
    public void set_gelismeTuru(GemiGelismeDurum _gelismeTuru) {
        this.gelismeTuru = _gelismeTuru;
    }
