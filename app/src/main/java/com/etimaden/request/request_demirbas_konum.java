...
public class request_demirbas_konum {
    ...
    private Demirbas_Konum demirbasKonum;

    public request_demirbas_konum() {
    }

    public request_demirbas_konum(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, Demirbas_Konum demirbasKonum) {
        ...
        this.demirbasKonum = demirbasKonum;
    }
    ...
    public Demirbas_Konum getDemirbasKonum() {
        return demirbasKonum;
    }

    public void setDemirbasKonum(Demirbas_Konum demirbasKonum) {
        this.demirbasKonum = demirbasKonum;
    }
}
