...
public class request_malzeme_sayim_isemri_list {
    ...
    private List<malzeme_sayim_isemri> malzeme_sayim_isemri_listesi;

    public request_malzeme_sayim_isemri_list() {
    }
    ...
    public List<malzeme_sayim_isemri> getMalzeme_sayim_isemri_listesi() {
        return malzeme_sayim_isemri_listesi;
    }

    public void setMalzeme_sayim_isemri_listesi(List<malzeme_sayim_isemri> malzeme_sayim_isemri_listesi) {
        this.malzeme_sayim_isemri_listesi = malzeme_sayim_isemri_listesi;
    }
}
