...
public class request_sevkiyat_zayi_arac {
    ...
    public request_sevkiyat_zayi_arac() {
    }

    public request_sevkiyat_zayi_arac(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, Zayi _zayi, Arac _arac) {
    ...
    public Arac get_arac() {
        return _arac;
    }

    public void set_arac(Arac _arac) {
        this._arac = _arac;
    }
}
