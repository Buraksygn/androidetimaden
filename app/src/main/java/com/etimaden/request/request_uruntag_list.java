...
public class request_uruntag_list {
    ...
    public request_uruntag_list() {
    }

    public request_uruntag_list(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, List<Urun_tag> urun_listesi) {
