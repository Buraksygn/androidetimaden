...
public class request_sevkiyat_aktarim {
    ...
    private aktarim _aktarim;

    public request_sevkiyat_aktarim() {
    }

    public request_sevkiyat_aktarim(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, aktarim _aktarim) {
    ...
    public aktarim get_aktarim() {
        return _aktarim;
    }

    public void set_aktarim(aktarim _aktarim) {
        this._aktarim = _aktarim;
    }
}
