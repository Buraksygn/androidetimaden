...
public class request_aktarim_list {
    ...
    private List<aktarim>  aktarimListesi;

    public request_aktarim_list() {
    }

    public request_aktarim_list(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, List<aktarim> aktarimListesi) {
        ...
        this.aktarimListesi = aktarimListesi;
    }
    ...
    public List<aktarim> getAktarimListesi() {
        return aktarimListesi;
    }

    public void setAktarimListesi(List<aktarim> aktarimListesi) {
        this.aktarimListesi = aktarimListesi;
    }
}
