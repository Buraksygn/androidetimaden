...
public class request_sevkiyat_isemri_uruntag_list_uruntag {
    ...
    private Sevkiyat_isemri sevk;
    private Urun_tag depo_urun;
    private List<Urun_tag> urun_listesi;

    public request_sevkiyat_isemri_uruntag_list_uruntag() {
    }

    public request_sevkiyat_isemri_uruntag_list_uruntag(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, Sevkiyat_isemri sevk, Urun_tag depo_urun, List<Urun_tag> urun_listesi) {
    ...
    public Sevkiyat_isemri getSevk() {
        return sevk;
    }

    public void setSevk(Sevkiyat_isemri sevk) {
        this.sevk = sevk;
    }

    public Urun_tag getDepo_urun() {
        return depo_urun;
    }

    public void setDepo_urun(Urun_tag depo_urun) {
        this.depo_urun = depo_urun;
    }

    public List<Urun_tag> getUrun_listesi() {
        return urun_listesi;
    }

    public void setUrun_listesi(List<Urun_tag> urun_listesi) {
        this.urun_listesi = urun_listesi;
    }
}
