...
public class request_demirbas_sayim_list {
    ...
    private List<demirbas_sayim>  demirbasSayimListesi;

    public request_demirbas_sayim_list() {
    }

    public request_demirbas_sayim_list(String _zsunucu_ip_adresi, String _zaktif_alt_tesis, String _zaktif_tesis, String _zsurum, String _zkullaniciadi, String _zsifre, String aktif_sunucu, String aktif_kullanici, List<demirbas_sayim>  demirbasSayimListesi) {
        ...
        this.demirbasSayimListesi = demirbasSayimListesi;
    }
    ...
    public List<demirbas_sayim> getDemirbasSayimListesi() {
        return demirbasSayimListesi;
    }

    public void setDemirbasSayimListesi(List<demirbas_sayim> demirbasSayimListesi) {
        this.demirbasSayimListesi = demirbasSayimListesi;
    }
}
