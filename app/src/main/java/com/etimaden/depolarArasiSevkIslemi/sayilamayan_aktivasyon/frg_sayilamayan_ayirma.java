...
public class frg_sayilamayan_ayirma extends Fragment {
    VeriTabani _myIslem;
    ...
    private apmblDepolararasiSevkSayilamayanAyirma adapter;



    public static frg_sayilamayan_ayirma newInstance() {

        return new frg_sayilamayan_ayirma();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.frg_sayilamayan_ayirma, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        adapter=new apmblDepolararasiSevkSayilamayanAyirma(new ArrayList<Urun_tag>(),getContext());
    ...
    public void barkodOkundu(String barkod){
        ...
        try
        {
            ...
            if (tag == null || !tag.islem_durumu.equals("31"))
            {
        ...
        public void onClick(View view)
        {
            try
            {
                ...
                else
                {
                    ...
                    Genel.showProgressDialog(getContext());
                    boolean res = persos.fn_sayilamayan_etiket_is_emri(v_Gelen);
                    Genel.dismissProgressDialog();
