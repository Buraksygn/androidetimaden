...
import com.etimaden.adapter.apmblSayimIslemleriSayimIslemiUrunAktivasyon;
...
public class frg_sayim_islemi_urun_aktivasyon extends Fragment {
    VeriTabani _myIslem;
    ...
    private apmblSayimIslemleriSayimIslemiUrunAktivasyon adapter;



    public static frg_sayim_islemi_urun_aktivasyon newInstance() {

        return new frg_sayim_islemi_urun_aktivasyon();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.frg_sayim_islemi_urun_aktivasyon, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        adapter=new apmblSayimIslemleriSayimIslemiUrunAktivasyon(new ArrayList<Urun_tag>(),getContext());
    ...
    public void barkodOkundu(String barkod){
        ...
        try
        {
            ...
            if (tag != null && tag.islem_durumu.equals("400"))
            {
                urunDegerlendir(tag);
            }
            else if(tag==null)
            {
                new SweetAlertDialogG(getContext(), SweetAlertDialogG.ERROR_TYPE)
                        ...
                        .setContentText("Ürün detayına ulaşılamadı.Bağlantı ayarlarınızı kontrol ediniz.")
            ...
            else
            {
                new SweetAlertDialogG(getContext(), SweetAlertDialogG.ERROR_TYPE)
                        .setTitleText("UYARI")
                        .setContentTextSize(25)
                        .setContentText("Bu menüden sadece sayım işlemi sırasında kullanılamayan etiketleri aktive edebilirsiniz.")
                        .showCancelButton(false)
                        .show();
            }
        ...
        public void onClick(View view)
        {
            try
            {
                ...
                else
                {
                    ...
                    request_uruntag_list v_Gelen=new request_uruntag_list();
                    v_Gelen.set_zaktif_alt_tesis(_ayaraktifalttesis);
                    v_Gelen.set_zaktif_tesis(_ayaraktiftesis);
                    v_Gelen.set_zkullaniciadi(_zkullaniciadi);
                    v_Gelen.set_zsifre(_zsifre);
                    ...
                    Genel.showProgressDialog(getContext());
                    boolean res = persos.fn_sayim_sırasinda_devre_disi_bırak(v_Gelen);
                    Genel.dismissProgressDialog();
