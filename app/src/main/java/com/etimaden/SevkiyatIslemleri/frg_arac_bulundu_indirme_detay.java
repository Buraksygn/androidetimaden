...
public class frg_arac_bulundu_indirme_detay extends Fragment {
    ...
    public frg_arac_bulundu_indirme_detay()
    {

    }

    public static frg_arac_bulundu_indirme_detay newInstance() {

        return new frg_arac_bulundu_indirme_detay();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.frg_arac_bulundu_indirme_detay, container, false);
    }
    ...
    private void fn_DegerleriYaz() {
        ...
        _txtBitenKalan2.setText("İŞEMRİ KALAN ADET / MİKTAR : " +aktif_sevk_isemri.kalan_palet_sayisi + " / " + aktif_sevk_isemri.kalan_agirlik);
    }
