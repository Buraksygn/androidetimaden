...
public class apmblSayimIslemleriDbIsletmeSecimi extends ArrayAdapter<Demirbas_Konum> {

    private ArrayList<Demirbas_Konum> dataSet;
    Context mContext;

    public apmblSayimIslemleriDbIsletmeSecimi(ArrayList<Demirbas_Konum> data, Context context) {
        super(context, R.layout.liste_sayim_islemleri_db_isletme_secimi_item, data);
        this.dataSet = data;
