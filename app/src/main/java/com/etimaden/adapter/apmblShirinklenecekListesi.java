...
public class apmblShirinklenecekListesi extends ArrayAdapter<Urun_tag> {

    private ArrayList<Urun_tag> dataSet;
    Context mContext;

    public apmblShirinklenecekListesi(ArrayList<Urun_tag> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.liste_uretim_shrink_eslestirme, parent, false);
        ...
        viewHolder._palet_id.setText(dataModel.getUrun_adi());
