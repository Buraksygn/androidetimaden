...
public class apmblSayimIslemleriDaIsemriSecimi extends ArrayAdapter<Demirbas_Konum> {

    private ArrayList<Demirbas_Konum> dataSet;
    Context mContext;

    public apmblSayimIslemleriDaIsemriSecimi(ArrayList<Demirbas_Konum> data, Context context) {
        super(context, R.layout.liste_sayim_islemleri_da_isemri_secimi_item, data);
        this.dataSet = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.liste_sayim_islemleri_da_isemri_secimi_item, parent, false);
