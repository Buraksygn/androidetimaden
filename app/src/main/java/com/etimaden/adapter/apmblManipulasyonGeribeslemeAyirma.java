...
public class apmblManipulasyonGeribeslemeAyirma extends ArrayAdapter<Urun_tag> {

    private ArrayList<Urun_tag> dataSet;
    Context mContext;

    public apmblManipulasyonGeribeslemeAyirma(ArrayList<Urun_tag> data, Context context) {
        super(context, R.layout.liste_manipulasyon_geribesleme_ayirma_item, data);
        this.dataSet = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.liste_manipulasyon_geribesleme_ayirma_item, parent, false);
